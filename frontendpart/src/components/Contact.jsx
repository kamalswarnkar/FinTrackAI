...
const Contact = () => {
  ...
  return (
    <div className="font-inter bg-gray-50 text-gray-800 min-h-screen">
      ...
      {/* Hero Section */}
      <section className="hero bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 text-center py-20 border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-5xl font-bold mb-6 text-gray-800 leading-tight">Get in Touch</h2>
      ...
      <section className="contact-main py-16 px-6 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-4xl mx-auto">
          <form className="contact-form bg-white p-8 rounded-xl shadow-lg mb-12 border border-gray-100" onSubmit={handleSubmit}>
            <h3 className="text-2xl font-semibold mb-8 text-gray-800 text-center">Send us a Message</h3>
            
            <div className="form-row flex flex-col md:flex-row gap-6 mb-6">
              <input
                type="text"
            ...
            <div className="form-row checkbox-row flex items-center mb-8">
            ...
            <div className="form-row button-row text-center">
              <button
                type="submit"
